...
class _VendorScreenState extends State<VendorScreen> {
  ...
  _locatePosition() async {
    ...
    CameraPosition cam = CameraPosition(target: latlngposition, zoom: 15);
      ...
      body: GoogleMap(
        ...
        markers: {
          Marker(
            ...
            position: LatLng(30.025603486746856, 31.438122242689136),
          ),
          Marker(
            markerId: MarkerId('2'),
            icon: BitmapDescriptor.defaultMarkerWithHue(100),
            position: LatLng(30.02723863572498, 31.44571825861931),
          ),
        },
      ),
    );
