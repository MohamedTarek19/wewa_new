                              ...
                              child: context.read<WewaProductsCubit>().flag2 == false
                                  ...
                                  : ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return InkWell(
                                          onTap: () {
                                            context.read<WewaProductsCubit>().FilteredProducts2[index].description = context.read<WewaProductsCubit>().parseHtmlString(context.read<WewaProductsCubit>().Products[index].description ?? '').trim();
                                            context.read<WewaProductsCubit>().FilteredProducts2[index].description = context.read<WewaProductsCubit>().Products[index].description?.replaceAll('\n', ',');
