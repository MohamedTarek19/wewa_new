                  ...
                  builder: (context, state) {
                    return GestureDetector(
                      onHorizontalDragUpdate: (details) async {
                        if(details.delta.dx < 0 && context.read<WewaProductsCubit>().itemCount <
                            (context.read<WewaProductsCubit>().cat.numberOfitems??0)){
                  ...
                  child: Stack(
                    children: [
                      Container(
                        ...
                        width: MediaQuery.of(context).orientation == Orientation.portrait?170:180,
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
